  ...
  return (
    <View style={tw`flex-1`}>
      ...
      <View style={tw`p-4 px-4 pt-10`}>
        ...
        {/* Old Password Input */}
        <View style={tw`mb-4`}>
          <Text style={tw`text-[#41414D] text-[14px] font-normal pb-[4px]`}>Old Password</Text>
          <View style={tw`relative flex-row items-center border px-2 rounded-md ${errors.oldPassword ? 'border-red-500' : 'border-gray-300'}`}>
            ...
            <Pressable onPress={toggleOldPasswordVisibility}>
              <SvgXml xml={showOldPassword ? EyeOffIcon : EyeIcon} width={20} height={20} style={tw`ml-2`} />
            </Pressable>
          </View>
          {errors.oldPassword && <Text style={tw`text-red text-xs`}>{errors.oldPassword.message}</Text>}
        </View>
